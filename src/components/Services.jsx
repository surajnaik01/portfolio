      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Let us transform your ideas into powerful video stories
            {/* Hand-drawn arrow */}
          ...
          <p className="text-lg md:text-xl text-gray-600 font-medium mb-12">
            Turning ideas into impactful videos through creative editing, storytelling, visual effects, and cinematic techniques
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="01"
            title="Description"
            text="We create engaging video edits with cinematic cuts, smooth transitions, and creative storytelling to make your content stand out.."
          ...
          <TagCard
            number="02"
            title="understand"
            text="Understanding your vision, style, and message to create the right editing approach."
          ...
          <TagCard
            number="03"
            title="Edit"
            text="Crafting engaging videos with professional cuts, pacing, effects, and storytelling."
          ...
          <TagCard
            number="04"
            title="Deliver"
            text="Delivering polished, high-quality videos that connect with your audience."
